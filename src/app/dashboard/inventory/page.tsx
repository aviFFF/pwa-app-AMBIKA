      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8 overflow-x-auto">
            ...
            <Link href="/dashboard/inventory" className="border-b-2 border-[#34495e] text-[#34495e] px-3 py-4 text-sm font-medium">Inventory</Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md mb-6">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button className="text-indigo-600 hover:text-indigo-900 mr-3">Update</button>
                    <button className="text-red-600 hover:text-red-900">Adjust</button>
                  </td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex justify-between">
            <div className="text-sm text-gray-600">Showing 4 of 358 items</div>
            <div className="flex">
